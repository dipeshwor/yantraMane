          ...
          if (keyPressed) 
          {
            if (key == 'a' || key == 'A')       //a to move forward 
            {
              ...
              if (next<10) 
              {
                if (animationID<10)
                {
                  bg = loadImage(sketchPath+"/data/a0"+animationID+"/a0"+animationID+"00"+next+".jpg");    //for images 1 to 9
                }
                else
                {
                  bg = loadImage(sketchPath+"/data/a"+animationID+"/a"+animationID+"00"+next+".jpg");    //for images 1 to 9
                }
              } 
              else
              {
                if (animationID<10)
                {
                  bg = loadImage(sketchPath+"/data/a0"+animationID+"/a0"+animationID+"0"+next+".jpg");    //for images 10 to 28
                }
                else
                {
                  bg = loadImage(sketchPath+"/data/a"+animationID+"/a"+animationID+"0"+next+".jpg");    //for images 10 to 28
                }
              }  
              background(bg);
              delay(10);
